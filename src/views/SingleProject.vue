  ...
  data: () => {
    return {
      ...
      projectInfo: {
        ...
        companyInfos: [
          {
            id: 1,
            title: "Project",
            details: "Platform Digital",
          },
          {
            id: 2,
            title: "Services",
            details: "Design Website/Portal",
          },
          {
            id: 3,
            title: "Website",
            details: "https://bit.ly/SAVELINE",
          },
          {
            id: 4,
            title: "Phone",
        ...
        objectivesDetails: "To be the most trusted financing platform for sustainable and demand-driven skill development.",
        technologies: [
          {
        ...
        socialSharings: [
          {
            ...
            name: "Twitter",
            icon: "twitter",
            url: "https://twitter.com/Aisah155",
          },
          {
            id: 2,
            name: "Instagram",
            icon: "instagram",
            url: "https://www.instagram.com/aisah__15/",
          },
          {
            id: 3,
            name: "Facebook",
          ...
          },
          {
            ...
            name: "LinkedIn",
            icon: "linkedin",
            url: "https://www.linkedin.com/in/aisah-28802320b/",
          },
          {
            id: 5,
            name: "Youtube",
