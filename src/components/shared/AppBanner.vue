...
<template>
  <section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10">
    ...
    <div class="w-full md:w-1/3 text-left">
      <h1 class="font-general-semibold text-3xl md:text-3xl xl:text-4xl text-center sm:text-left text-ternary-dark dark:text-primary-light uppercase">Hi, Iam Aisah</h1>
      <p class="font-general-medium mt-2 text-lg sm:text-xl xl:text-2xl text-center sm:text-left leading-none text-gray-400">UI Designer</p>
      <div class="flex justify-center sm:block">
        <a
          download="cv_aisah.pdf"
          href="#"
    ...
    <div class="w-full md:w-2/3 text-right float-right">
      <img v-if="theme === 'light'" src="@/assets/images/hor-pf.jpg" alt="Developer" width="300" />
      <img v-else src="@/assets/images/hor-pf.jpg" alt="Developer" width="300" />
    </div>
  </section>
</template>
